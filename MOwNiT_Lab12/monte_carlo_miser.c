...
int main(int argc, char* argv[]) {
    ...
    gsl_monte_miser_integrate(&F, xl, xu, dim, n, r, s, &res, &err);
    printf("x^2 + x + 1\n");
    printf("res = %f\n", res);
    printf("err = %f\n", err);
    ...
    gsl_monte_miser_integrate(&G, xl, xu, dim, n, r, s, &res, &err);
    printf("sqrt(1 - x^2)\n");
    printf("res = %f\n", res);
    printf("err = %f\n", err);
    ...
    gsl_monte_miser_integrate(&H, xl, xu, dim, n, r, s, &res, &err);
    printf("1/sqrt(x)\n");
    printf("res = %f\n", res);
    printf("err = %f\n", err);
